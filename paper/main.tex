...
\textbf{Disagreement Approach.} TMDL treats disagreement as a secondary specification---what to do when the teammate's analysis differs from team consensus---rather than a primary interaction mode. The four approaches (defer, voice, dialogue, investigate) are designed for collaborative resolution: understanding different perspectives, seeking additional information, and finding common ground.
...
\textit{Rationale:} Research on high-performing teams emphasizes mutual support, backup behavior, and coordination \cite{salas2005bigfive}. AI teammates configured for positive contribution should integrate more naturally into team dynamics.
