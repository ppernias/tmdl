...
\textbf{Cognitive Style Taxonomy.} Research on cognitive styles provides a rigorous foundation for differentiating thinking patterns. Kozhevnikov \cite{kozhevnikov2007cognitive} synthesized decades of research into an integrated framework showing that cognitive styles represent stable individual differences in information processing that are distinct from abilities. Kirton's Adaption-Innovation theory \cite{kirton1976adaptors} established a fundamental dimension: adaptors who improve within existing paradigms versus innovators who challenge them. Critically, Aggarwal and Woolley \cite{aggarwal2019cognitive} demonstrated empirically that cognitive style diversity in teams improves collective performance through enhanced team cognition.

TMDL operationalizes these findings through seven cognitive styles (analytical, creative, devils\_advocate, optimist, pragmatist, visionary, balanced) that represent functional modes of reasoning. These are not personality traits but assignable cognitive orientations that can be deliberately configured to create complementary team compositions.
...
Cognitive styles draw from research on cognitive diversity \cite{kozhevnikov2007cognitive, kirton1976adaptors}: devils\_advocate, optimist, pragmatist, visionary, analytical, creative, and balanced.
...
The specification reflects TMDL's theoretical foundations: \texttt{contribution\_style: analytical} draws from team composition research on functional role diversity; \texttt{disagreement\_approach: dialogue} reflects collaborative orientation; explicit \texttt{protocols} operationalize predictable behavior patterns.
